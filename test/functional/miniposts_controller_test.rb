...
class MinipostsControllerTest < ActionController::TestCase
  ...
  test "should create minipost" do
    assert_difference('Minipost.count') do
      post :create, minipost: { content: @minipost.content, integer: @minipost.integer, user_id: @minipost.user_id }
    end
  ...
  test "should update minipost" do
    put :update, id: @minipost, minipost: { content: @minipost.content, integer: @minipost.integer, user_id: @minipost.user_id }
    assert_redirected_to minipost_path(assigns(:minipost))
  end
